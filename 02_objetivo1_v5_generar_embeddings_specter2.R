# ============================================================
# 02_objetivo1_v5_generar_embeddings_specter2.R
# Objetivo 1 v5
# Generar embeddings SPECTER2 sobre corpus enriquecido
# basado en docs_interest + GS/OpenAlex
# ============================================================
...
input_sample <- file.path(
  v5_dir,
  "dataset_objetivo1_v5_docs_interest_for_embeddings_sample_1000.csv"
)
...
# ------------------------------------------------------------
# Cambia a "full" cuando la prueba sample funcione.
# Opciones: "sample" o "full"
# ------------------------------------------------------------
...
out_dir_sample <- file.path(
  embeddings_dir,
  "specter2_classification_v5_docs_interest_enriched_sample_1000"
)

out_dir_full <- file.path(
  embeddings_dir,
  "specter2_classification_v5_docs_interest_enriched"
)
...
stop_if_missing(input_full, "dataset v5 para embeddings")
...
if (!file.exists(input_sample)) {
  ...
  cat("\nCreando muestra de 1,000 documentos...\n")
...
# ============================================================
# 5) Seleccionar modo de ejecución
# ============================================================
...
if (run_mode == "sample") {
  ...
  step_label <- "Generar embeddings SPECTER2 v5 - muestra 1000"
  
} else if (run_mode == "full") {
  
  input_run <- input_full
  output_dir <- out_dir_full
  step_label <- "Generar embeddings SPECTER2 v5 - corpus completo"
